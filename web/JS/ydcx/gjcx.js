                        ...
                        columns: [
                            {
                                ...
                                renderer: function (value, cellmeta, record, rowIndex, columnIndex, store) {
                                    return "<a href='javascript:void(0);' onClick='ShowGJ(\"" + value + "\",\"" + record.data.YunDanDenno + "\");'>轨迹回放</a>";
                                }
                            },
                            {
                                xtype: 'datecolumn',
...
function DataBind(cp) {
    CS('CZCLZ.Handler.SearchMyYunDanByGJ', function (retVal) {
        if (retVal) {
            myStore.setData({
                data: retVal.dt,
                pageSize: pageSize,
...
function ShowGJ(UserID, YunDanDenno) {
    FrameStack.pushFrame({
        url: "gjhf.html?UserID=" + UserID + "&YunDanDenno=" + YunDanDenno + "&type=wodeyundan",
