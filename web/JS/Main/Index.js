    ...
    Ext.define('MainViewport', {
        ...
        initComponent: function () {
            ...
            me.items = [
            {
                ...
                html: '<div class="LoginHeader"><div class=leftHeader><a href="" target="mainframe"><img alt="查货宝订单管理系统" src="../images/logo/' + logo + '"></a></div><div class="rightHeader"><a href="" target="mainframe"><img align="absmiddle" src="approot/d/images/home.png">首页</a><a onclick="logout()" href="javascript:void(0);"><img align="absmiddle" src="approot/d/images/exit.png">退出</a></div></div>'
            ...
            },
            {
                ...
                padding: 2,
                id: 'MainPanel',
                html: '<iframe name="mainframe" id="mainframe" frameborder="0" src="page/zhidan/zhidan.html" width="100%" height="100%">'
            }
            ];
